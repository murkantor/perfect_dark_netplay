...
# here drives cmake/toolchain-nxdk.cmake. The toolchain's target triple/flags and
# the PE->XBE (cxbe) step still need confirming on a real NXDK install -- see
# docs/PORT_XBOX_NXDK.md.
